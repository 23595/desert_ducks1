...
# For every setting, go through each question and each answer and add
# ans_points of ten and ans_explain of the setting, question, answer
# to the game_logic table
